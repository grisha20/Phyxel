...
public sealed class MaterialRegistry
{
    ...
    private static List<MaterialDefinition> CreateBuiltIns()
    {
        ...
        [
            ...
            Create(MaterialId.Sand, "Песок", new Color(218, 184, 92), MaterialSimulationKind.CellularAutomata, 1.5f, 0f, 0f, 0.55f, 0.05f, 0.15f),
            Create(MaterialId.Water, "Вода", new Color(43, 132, 207), MaterialSimulationKind.CellularAutomata, 1f, 0f, 0f, 0.02f, 0.02f, 1f),
            Create(MaterialId.Metal, "Металл", new Color(142, 156, 166), MaterialSimulationKind.Lattice, 7.8f, 0.08f, 0.32f, 0.35f, 0.12f, 0f),
            Create(MaterialId.Concrete, "Бетон", new Color(125, 121, 112), MaterialSimulationKind.Lattice, 2.4f, 0.015f, 0.07f, 0.75f, 0.03f, 0f),
