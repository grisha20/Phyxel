...
Сейчас проект находится на ранней стадии разработки. Уже работают базовая физика granular/liquid/gas/solid, JSON-материалы, сохранения и универсальная температура с ручным температурным инструментом. Реакции, фазовые переходы, огонь, контент-паки и сетевой hub ещё не реализованы.
...
Последний проверенный коммит документации: `4d4eb7c Add interactive temperature brush`.
