...
`FixedStepGasScheduler` выдаёт шаги по 1/60 с. Один tick запускает четыре `GasRedistribution` dispatch: чередующийся parity вертикальных соседей, оба parity горизонтальных соседей и одну диагональ каждой непересекающейся группы 2×2.
