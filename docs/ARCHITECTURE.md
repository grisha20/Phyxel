...
`FixedStepGasScheduler` выдаёт шаги по 1/120 с. Один tick запускает четыре `GasRedistribution` dispatch: чередующийся parity вертикальных соседей, оба parity горизонтальных соседей и одну диаональ каждой непересекающейся группы 2×2. Темп 120 Гц удваивает всё локальное движение газа относительно прежнего режима 60 Гц, не меняя JSON-коэффициенты.
